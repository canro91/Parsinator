...
{
    public class FromFirstRegexToLastRegex : IParse
    {
        ...
        public FromFirstRegexToLastRegex(String key, Regex first, Regex second, Func<List<String>, String> factory, Func<String> @default)
        {
            this.Key = key;
