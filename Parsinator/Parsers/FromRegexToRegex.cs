...
{
    public class FromRegexToRegex : ParseWithFactory
    {
        ...
        public FromRegexToRegex(String key, Regex first, Regex second, Func<IDictionary<String, String>, String> factory, Func<String> @default)
            : base(key, factory)
        {
        ...
        public FromRegexToRegex(String key, Regex first, Regex second, Func<IDictionary<String, String>, String> factory)
